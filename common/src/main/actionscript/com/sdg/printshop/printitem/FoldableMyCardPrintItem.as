package com.sdg.printshop.printitem
{
	...
	import com.sdg.view.avatarcard.AvatarCardBack;
	...
	public class FoldableMyCardPrintItem extends Sprite implements IPrintItem
	{
		...
		private var back1:AvatarCardBack;
		private var back2:AvatarCardBack;
		private var back3:AvatarCardBack;
		...
		public function FoldableMyCardPrintItem()
		{
			...
			back1 = new AvatarCardBack(av, 320, 450);
			back1.init();
			back1.addEventListener(Event.COMPLETE,onBack1Ready);
			back2 = new AvatarCardBack(av, 320, 450);
			back2.init();
			back2.addEventListener(Event.COMPLETE,onBack2Ready);
			back3 = new AvatarCardBack(av, 320, 450);
			back3.init();
