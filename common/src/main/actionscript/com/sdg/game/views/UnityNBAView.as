package com.sdg.game.views
{
	...
	public class UnityNBAView extends Sprite implements IUnityNBAView
	{
		...
		public function UnityNBAView()
		{
			...
			var background:QuickLoader = new QuickLoader("assets/swfs/nbaAllStars/nbaBackground.swf", onBackgroundLoaded);
			var quitButton:QuickLoader = new QuickLoader("assets/swfs/nbaAllStars/Button_Quit.swf", onQuitLoaded);
