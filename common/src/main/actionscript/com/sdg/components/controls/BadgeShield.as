package com.sdg.components.controls
{
	...
	public class BadgeShield extends Sprite
	{
		...
		{			
			...
			var request:URLRequest = new URLRequest('assets/swfs/pda/badges/animated_badge_' + value + '.swf');
		...
		{			
			...
			//var request:URLRequest = new URLRequest('assets/swfs/pda/badges/badge_sportPsychic_image.swf');
