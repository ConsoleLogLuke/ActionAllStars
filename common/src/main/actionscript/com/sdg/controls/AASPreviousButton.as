package com.sdg.controls
{
	...
	import com.sdg.shape.PointLeftBox;
	...
	public class AASPreviousButton extends BasicButton
	{
		public function AASPreviousButton(label:String = 'Previous', width:Number = 100, height:Number = 34)
		{
			...
			_buttonBacking = new ShapeBox(new PointLeftBox(0, 0, _width, _height, 12), _width, _height);
