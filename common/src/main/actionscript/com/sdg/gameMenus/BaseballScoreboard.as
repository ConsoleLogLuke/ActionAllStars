	...
	public class BaseballScoreboard extends Sprite
	{
										...
										isHome:Boolean, width:Number = 925, height:Number = 260)
		{
			...
			if (isHome)
			{
				...
				{
					homeWLDisplay = createDisplay("assets/swfs/rbi/results_YOUWIN.swf");
					awayWLDisplay = createDisplay("assets/swfs/rbi/results_LOSER.swf");
				}
				else if (homeScore < awayScore)
				{
					homeWLDisplay = createDisplay("assets/swfs/rbi/results_YOULOSE.swf");
					awayWLDisplay = createDisplay("assets/swfs/rbi/results_WINNER.swf");
				}
			}
			else
			{
				if (homeScore > awayScore)
				{
					homeWLDisplay = createDisplay("assets/swfs/rbi/results_WINNER.swf");
					awayWLDisplay = createDisplay("assets/swfs/rbi/results_YOULOSE.swf");
				}
				else if (homeScore < awayScore)
				{
					homeWLDisplay = createDisplay("assets/swfs/rbi/results_LOSER.swf");
					awayWLDisplay = createDisplay("assets/swfs/rbi/results_YOUWIN.swf");
				}
			}
