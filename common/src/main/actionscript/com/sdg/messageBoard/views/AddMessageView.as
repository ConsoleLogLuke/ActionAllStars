package com.sdg.messageBoard.views
{
	...
	public class AddMessageView extends Sprite
	{
		...
		public function AddMessageView(model:AddMessageModel)
		{
			...
			var background:QuickLoader = new QuickLoader("assets/swfs/turfBuilder/msgBoard/NotePad.swf", onBGComplete);
...
//			addChild(stickerWindow);
			...
			_postItButton = new QuickLoader("assets/swfs/turfBuilder/msgBoard/ButtonPostIt.swf", onPostItButtonComplete);
