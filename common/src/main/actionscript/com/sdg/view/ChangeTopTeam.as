	...
	public class ChangeTopTeam extends UIComponent
	{
		...
		private function initTeams():void
		{
			...
			if (_basketballTeam == null)
				_basketballLogo = new TeamIconUncropped(34, 34, 0x999999, 0x333333, 0, "swfs/teamAffinity/iconBasketball.swf");
			else
			...
			if (_baseballTeam == null)
				_baseballLogo = new TeamIconUncropped(34, 34, 0x999999, 0x333333, 0, "swfs/teamAffinity/iconBaseball.swf");
			else
			...
			if (_footballTeam == null)
				_footballLogo = new TeamIconUncropped(34, 34, 0x999999, 0x333333, 0, "swfs/teamAffinity/iconFootball.swf");
			else
		...
		{
			_background = new QuickLoader("swfs/teamAffinity/changeTopTeamBG.swf", onComplete);
